...
export default function Register() {
  ...
  const [step, setStep] = useState(1); // for Artisan 2-step form
      ...
      >
        ...
        <div className="relative z-10 text-center mb-10">
          ...
          <p className="text-green-100 text-base">
            {role === "Artisan"
              ? "Join as a Artisan and get hired"
              : "Find trusted Artisan near you"}
          </p>
        </div>
        ...
        <div className="relative z-10 flex gap-8">
          ...
          <div className="text-center">
            ...
            <p className="text-green-100 text-xs mt-1">Verified Artisan</p>
          </div>
          <div className="w-px bg-green-400 opacity-50" />
          <div className="text-center">
      ...
      >
        ...
        <div className="w-full max-w-md">
          ...
          <div className="card">
            ...
            {/* STEP 1 — Account Info (both user and Artisan) */}
            {step === 1 && (
              <form
                onSubmit={role === "artisan" ? handleNextStep : handleSubmit}
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-2xs text-gray-400 mt-1">
                    Must include letters, numbers and a symbol
                  </p>
                </div>
                ...
                <button
                  type="button"
                  onClick={() =>
                    (window.location.href = getApiAuthUrl("/google"))
                  }
            ...
            {/* STEP 2 — Business Details (Artisan only) */}
            {step === 2 && role === "artisan" && (
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  {locError && (
                    <div
                      className="bg-red-50 dark:bg-red-500/10 text-red-600 
                    dark:text-red-400 text-xs px-3 py-2 rounded-md mb-2"
                    >
                      {locError}
                    </div>
                  )}
               ...
               border-green-200 dark:border-green-500/30 rounded-md py-2.5 
               px-4 text-sm font-medium text-green-600 dark:text-green-400
               hover:bg-green-50 dark:hover:bg-green-500/10 bg-white 
               dark:bg-dark-surface transition-colors mb-2
               disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    {locLoading ? (
                      <>
                        <div
                          className="w-4 h-4 border-2 border-green-500 border-t-transparent 
                  ...
                  {form.address && (
                    <div
                      className="flex items-start gap-2 bg-green-50 dark:bg-green-500/10 
                    border border-green-200 dark:border-green-500/30 
                    rounded-md px-3 py-2.5 mb-2"
                    >
                      <svg
                  ...
                  />
                  <p className="text-2xs text-gray-400 mt-1">
                    Include area and city/state, for example: 12 Admiralty Way, Lekki, Lagos.
                  </p>
                </div>
          ...
          <p className="text-center text-xs text-gray-400 mt-4">
            Want to join as a {role === "user" ? "artisan" : "user"} instead?{" "}
            <Link
              to={`/register/form?role=${role === "user" ? "artisan" : "user"}`}
